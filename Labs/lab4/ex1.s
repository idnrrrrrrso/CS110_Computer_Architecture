...
inc_arr_loop:
    ...
    # t1 在这个循环的后半段不会再被使用了，而在下个循环的开始时会被重新初始化
    jal helper_fn
...
# Checks the result of inc_arr, which should contain 1 2 9 16 25 after
# one call.
