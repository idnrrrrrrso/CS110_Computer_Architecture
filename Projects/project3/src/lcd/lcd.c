...
// void LCD_DrawPoint_on_frame(u16 (*frame)[LCD_W * LCD_H], u16 x, u16 y,
//                             u16 color) {
//   (*frame)[x + y * LCD_W] = color;
// }
...
// void LCD_DrawPoint_big_on_frame(u16 (*frame)[LCD_W * LCD_H], u16 x, u16 y,
//                                 u16 color) {
//   LCD_Fill_on_frame((*frame), x - 1, y - 1, x + 1, y + 1, color);
// }
...
// void LCD_Fill_on_frame(u16 (*frame)[LCD_W * LCD_H], u16 xsta, u16 ysta,
//                        u16 xend, u16 yend, u16 color) {
//   u16 i, j;
//   for (i = ysta; i <= yend; i++) {
//     for (j = xsta; j <= xend; j++)
//       (*frame)[i + j * LCD_W] = color;
//   }
// }
/******************************************************************************
...
// void LCD_DrawLine_on_frame(u16 (*frame)[LCD_W * LCD_H], u16 x1, u16 y1, u16
// x2,
//                            u16 y2, u16 color) {
//   u16 t;
//   int xerr = 0, yerr = 0, delta_x, delta_y, distance;
...
//     distance = delta_y;
//   for (t = 0; t < distance + 1; t++) {
//     LCD_DrawPoint_on_frame(frame, uRow, uCol, color); // 画点
//     xerr += delta_x;
//     yerr += delta_y;
//     if (xerr > distance) {
//       xerr -= distance;
...
// void LCD_DrawRectangle_on_frame(u16 (*frame)[LCD_W * LCD_H], u16 x1, u16 y1,
//                                 u16 x2, u16 y2, u16 color) {
//   LCD_DrawLine_on_frame(frame, x1, y1, x2, y1, color);
//   LCD_DrawLine_on_frame(frame, x1, y1, x1, y2, color);
//   LCD_DrawLine_on_frame(frame, x1, y2, x2, y2, color);
//   LCD_DrawLine_on_frame(frame, x2, y1, x2, y2, color);
// }
...
// void LCD_ShowChar_on_frame(u16 (*frame)[LCD_W * LCD_H], u16 x, u16 y, u8 num,
//                            u8 mode, u16 color) {
//   u8 temp;
//   u8 pos, t;
//   u16 x0 = x;
...
//       for (t = 0; t < 8; t++) {
//         if (temp & 0x01)
//           (*frame)[(x + t) + (y + pos) ^ LCD_W] = color;
//         else
//           (*frame)[(x + t) + (y + pos) ^ LCD_W] = BLACK;
//         temp >>= 1;
//         x++;
//       }
//       x = x0;
...
//       for (t = 0; t < 8; t++) {
//         if (temp & 0x01)
//           LCD_DrawPoint_on_frame(frame, x + t, y + pos,
//                                  color); // Draw a dot
//         temp >>= 1;
//       }
//     }
...
// void LCD_ShowString_on_frame(u16 (*frame)[LCD_W * LCD_H], u16 x, u16 y,
//                              const u8 *p, u16 color) {
//   while (*p != '\0') {
//     if (x > LCD_W - 16) {
//       x = 0;
//       y += 16;
...
//       LCD_Clear(RED);
//     }
//     LCD_ShowChar_on_frame(frame, x, y, *p, 0, color);
//     x += 8;
//     p++;
//   }
// }
